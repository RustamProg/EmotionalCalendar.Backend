...
namespace EmotionalCalendar.Backend.WebAPI.Migrations
{
    ...
    [Migration("20210929141047_FirstTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmotionalCalendar.Backend.Models.EmotionModels.DailyEmotion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EmotionalCalendar.Backend.Models.EmotionModels.Emotion", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("EmotionalCalendar.Backend.Models.EmotionModels.EventNote", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("EmotionalCalendar.Backend.Models.EmotionModels.DailyEmotion", b =>
                {
                    b.HasOne("EmotionalCalendar.Backend.Models.EmotionModels.Emotion", "Emotion")
                        .WithMany()
                        .HasForeignKey("EmotionId");

                    b.HasOne("EmotionalCalendar.Backend.Models.EmotionModels.EventNote", "EventNote")
                        .WithMany()
